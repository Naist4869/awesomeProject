...
func (r reqAccessToken) intoURLValues() url.Values {
	return url.Values{
		"corpid":     {r.CorpID},
...
var _ urlValuer = (*reqAccessToken)(nil)
...
type respDeptList struct {
	...
	Department []*wxmodel.DeptInfo `json:"department"`
}
...
type respAppchatGet struct {
	...
	ChatInfo *wxmodel.ChatInfo `json:"chat_info"`
}

// reqAppchatCreate 创建群聊会话请求
type reqAppchatCreate struct {
	ChatInfo *wxmodel.ChatInfo
}
...
func (x reqMediaUpload) getMedia() *wxmodel.Media {
	return x.Media
}
...
func (x reqMediaUploadImg) getMedia() *wxmodel.Media {
	return x.Media
}
